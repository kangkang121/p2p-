...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="/js/plugins/uploadfive1.2.2/uploadifive.css" />
		<script type="text/javascript" src="/js/plugins/uploadfive1.2.2/jquery.uploadifive.min.js"></script>
		...
		$(function(){
            ...
            $("#uploadBtn1").uploadifive({
				...
				fileSizeLimit: 53242880,
                multi:false,
                queueSizeLimit : 1,
                overrideEvents : ['onError','onUploadComplete'],
                onError: function(errorType) {
                    if(errorType=='FORBIDDEN_FILE_TYPE'){
                        $.messager.popup("只能上传图片");
                    }
                },
				...
				onFallback : function () {
					$.messager.alert("提示",",浏览器不兼容,请更换浏览器!");
                }
            });
						...
						<div class="panel-heading">
							...
							<fieldset>
								...
								<div class="form-group">
					        		...
					        		<div class="col-sm-8">
						        		<p class="form-control-static">${loginfor.username }</p>
						        	</div>
						        </div>
								<div class="form-group">
						        ...
						        <div class="form-group">
					        		...
					        		<div class="col-sm-8">
						        		<input id="birthDate" readonly placeHolder="点击选择日期" onclick="WdatePicker()" class="form-control" name="bornDate" type="text">
						        	</div>
						        </div>
						        <div class="form-group">
