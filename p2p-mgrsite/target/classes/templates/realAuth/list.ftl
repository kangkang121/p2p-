		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/realAuth">
                    ...
                    <script>
                        $('#stateSelect option[value="${(qo.state)!""}"]').attr('selected',true);
                    </script>
					<div class="form-group">
					    <label>申请时间</label>
					    <input class="form-control" type="text" name="beginDate" id="beginDate"value='${(qo.beginDate?string("yyy-MM-dd"))!""}' />到
					    <input class="form-control" type="text" name="endDate" id="endDate" value='${(qo.endDate?string("yyy-MM-dd"))!""}' />
					</div>
					<div class="form-group">
